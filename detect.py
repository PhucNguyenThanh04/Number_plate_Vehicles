...
#                     _, license_plates_crop_thresh = cv2.threshold(license_plates_crop_gray, 64, 255,
...
def writer_bbx(cap , csv_output_path):
    ...
    pbar = tqdm(total=total_frames, desc="Processing video")  # 👈 tạo tqdm progress bar
    ...
    while ret:
        ...
        if detection_vehs_:
            ...
            track_id = []  # tránh lỗi nếu không có detection
